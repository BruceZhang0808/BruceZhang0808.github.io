+++
date = '2025-11-26T14:03:58+08:00'
draft = true
title = 'Change Detection'
author = 'BruceZhang'
+++

## 1 [ChangeCLIP: Remote sensing change detection with multimodal vision-language representation learning](https://www.sciencedirect.com/science/article/pii/S0924271624000042)
...
![ChangeCLP](ChangeCLIP_arch.jpg "ChangeCLP")

代码：<https://github.com/dyzy41/ChangeCLIP>

## 2 [ChangeMamba: Remote Sensing Change Detection with Spatio-Temporal State Space Model]([[2404.03425] ChangeMamba: Remote Sensing Change Detection With Spatiotemporal State Space Model](https://arxiv.org/abs/2404.03425))
